...
OUTPUT_DIR=${DATA_DIR}/outputs/SimplePendulum-v0/safe_explorer_ppo/pretrain/$(date +"%Y-%m-%d_%H-%M-%S")
MODEL_PATH=${OUTPUT_DIR}/checkpoints/model_latest.pt
# MODEL_PATH=${DATA_DIR}/outputs/SimplePendulum-v0/safe_explorer_ppo/pretrain/2023-01-23_13-29-31/checkpoints/model_latest.pt
