...
# general settings
task="cartpole"
OUTPUT_DIR=${DATA_DIR}/outputs/SafeCartPole-v0/safe_explorer_ppo/pretrain/$(date +"%Y-%m-%d_%H-%M-%S")
MODEL_PATH=${OUTPUT_DIR}/checkpoints/model_latest.pt
# MODEL_PATH=/home2/tom.haider/Code/x_mpsc/data/outputs/SafeCartPole-v0/safe_explorer_ppo/pretrain/2023-01-23_15-49-00/checkpoints/model_latest.pt
