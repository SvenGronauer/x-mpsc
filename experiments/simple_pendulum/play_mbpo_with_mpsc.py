...
def record_video(
    ...
    for stage in pbar:
        ...
        log_dir = "/var/tmp/videos/SimplePendulum-v0"
...
if __name__ == '__main__':
    ...
    if args.ckpt is None:
        base_dir = "/var/tmp/sven/SimplePendulum-v0/mbpo/"
    ...
    env = SimplePendulumPlotWrapper(unwrapped_env)
    ...
    # try:
    #     state_dict = joblib.load(os.path.join(path, 'state.pkl'))
    # except:
    #     state_dict = None
    #     loggers.warn('Warning: could not load state_dict.')
