...
from x_mpsc.algs.core import ConstrainedPolicyGradientAlgorithm
from x_mpsc.algs.trpo.trpo import TRPOAlgorithm
...
class LagrangianTRPOAlgorithm(TRPOAlgorithm,
    ...
    def __init__(
        ...
        TRPOAlgorithm.__init__(
            self,
            alg=alg,
            lambda_lr=lambda_lr,  # pass to log in config.json
    ...
    def compute_loss_pi(
        ...
        # Policy loss
        dist, _log_p, lstm_state = self.ac.pi(data['obs'], data['act'])
